# Research P0-009 domain recovery

- Freeze tag: `p0-009a-pre-20260729`
- Scope: the parent repository and all four Research component repositories
...
```bash
git -C /home/zymun/research-app/research-web-frontend \
...
The retained agent and retrieval implementation lives in the normal
